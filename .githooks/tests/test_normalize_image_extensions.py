...
def load_module():
    loader = importlib.machinery.SourceFileLoader("normalize_image_extensions", str(MODULE_PATH))
    spec = importlib.util.spec_from_loader("normalize_image_extensions", loader)
...
class NormalizeImageExtensionsHookTests(unittest.TestCase):
