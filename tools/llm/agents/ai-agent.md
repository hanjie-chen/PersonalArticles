...
1. 关于实事求是，在命令失败之后不要瞎编乱造
   ...
   Get-Process git, Codex, codex -ErrorAction SilentlyContinue | Stop-Process -Force
   
   Get-Process git, Codex, codex -ErrorAction SilentlyContinue
   
   Remove-Item 'C:\Users\Windows 10\.codex\vendor_imports\skills\.git\shallow.lock' -Force
